...
appearance = st.slider("Select Age", min_value=0, max_value=100, value=25)
highest_value = st.slider("Select Current Value", min_value=0, max_value=1_000_000_00, value=5_000)
